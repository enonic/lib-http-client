 ...
 * @param {number} [params.allowHttp2=false] Allow HTTP client to negotiate HTTP/2 protocol. For insecure http connections HTTP/2 is always disabled.
...
exports.request = function (params) {
    ...
    bean.setAllowHttp2(params.allowHttp2 === true);
